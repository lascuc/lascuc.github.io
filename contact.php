...
a.style2:link{color:#FF9900;text-decoration: none;}
a.style2:visited{color:#FF9900;text-decoration: none;}
a.style2:hover{color:#FF9900;text-decoration: underline;}
a.style2:active{color:#FF9900;text-decoration: none;}
</style>
...
<body>
<div id="container">
<div id="image2" style="position:absolute; overflow:hidden; left:0px; top:116px; width:206px; height:287px; z-index:0"><img src="images/topline003.jpg" alt="" title="" border=0 width=206 height=287></div>

<div id="image1" style="position:absolute; overflow:hidden; left:0px; top:29px; width:502px; height:88px; z-index:1"><img src="images/topline001.jpg" alt="" title="" border=0 width=502 height=88></div>

<div id="image3" style="position:absolute; overflow:hidden; left:151px; top:238px; width:585px; height:31px; z-index:2"><img src="images/topline004.jpg" alt="" title="" border=0 width=585 height=31></div>

<div id="image4" style="position:absolute; overflow:hidden; left:371px; top:267px; width:24px; height:443px; z-index:3"><img src="images/vertline001.gif" alt="" title="" border=0 width=24 height=443></div>

<div id="hr1" style="position:absolute; overflow:hidden; left:384px; top:674px; width:354px; height:46px; z-index:4">
...
<div class="wpmd">
<div><font color="#FF9900"><B>Lasa un mesaj&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Istoric mesaje</B></font></div>
<div><font color="#808080" face="Tahoma" class="ws8"><BR></font></div>
</div></div>
...
<div class="wpmd">
<div><font face="Tahoma" class="ws8">Nume:</font></div>
</div></div>

<div id="text4" style="position:absolute; overflow:hidden; left:173px; top:345px; width:137px; height:18px; z-index:11">
<div class="wpmd">
<div><font face="Tahoma" class="ws8">E-mail (nu va fi afisat):</font></div>
</div></div>

<div id="text5" style="position:absolute; overflow:hidden; left:173px; top:400px; width:137px; height:18px; z-index:12">
<div class="wpmd">
<div><font face="Tahoma" class="ws8">Mesaj:</font></div>
</div></div>

<input name="email" type="text" maxlength=50 style="position:absolute;width:138px;left:173px;top:360px;z-index:13">
...
$mesaj1=mysql_result($result,$i,"mesaj");
$time=mysql_result($result,$i,"time(date)");
$date=mysql_result($result,$i,"date(date)");
?>
<tr>
<td align="left"><b><font color="#808080" face="Tahoma" class="ws8"><?php echo "$nume1";?> a zis:</font></b></td>
<td align="right"><b><font color="#808080" face="Tahoma" class="ws8">la <?php echo "$time pe $date"; ?></font></b></td>
</tr>
<tr>
